/**
  ...
  @return {Promise}
 */
declare function selectFiles(target: string | HTMLElement, ...files: (File | Blob)[]): Promise<void>;
/**
  ...
  @return {Promise}
 */
declare function dragAndDrop(target: string | HTMLElement, ...files: (File | Blob)[]): Promise<void>;
/**
  ...
  @return {Promise}
 */
declare function dragEnter(target: string | HTMLElement, ...files: (File | Blob)[]): Promise<void>;
/**
  ...
  @return {Promise}
 */
declare function dragLeave(target: string | HTMLElement, ...files: (File | Blob)[]): Promise<void>;
export { selectFiles, dragAndDrop, dragEnter, dragLeave };
