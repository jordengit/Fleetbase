...
function evaluateColorMath(left, right, op) {
    var val1 = (0, _cssColorConverter.fromString)(left.value).toRgbaArray();
    var val2 = (0, _cssColorConverter.fromString)(right.value).toRgbaArray();
    ...
    return {
        type: 'ColorValue',
        value: (0, _cssColorConverter.fromRgba)([r, g, b, a]).toHexString()
    };
}
