...
export default class ClassBasedModifierManager {
    ...
    createModifier(factoryOrClass: Factory<typeof ClassBasedModifier> | typeof ClassBasedModifier, args: ModifierArgs): ClassBasedModifier;
    installModifier(instance: ClassBasedModifier, element: Element, args: ModifierArgs): void;
